...
export default function AppClean() {
  ...
  const [inspectedPlant, setInspectedPlant] = useState(null); // Pour le modal d'inspection en mode Planner
        ...
        <div className="app-body">
          ...
          <main className="content-clean">
            ...
            {mode === 'planner' && inspectedPlant && (
              <div className={`plant-inspector-modal ${theme}`}>
